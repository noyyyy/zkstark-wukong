      ...
      _export("HolCharacter", HolCharacter = (_dec = ccclass('HolCharacter'), _dec(_class = class HolCharacter extends Component {
        ...
        async action() {
          ...
          if (actionState.actionMethod === "attack" && actionState.canAction) {
            ...
            await this.state.OnAttack(this.state, actionState, this.$fightMap); // 攻击回蓝

            this.state.energy += 20 + 3 * this.state.intelligence1;
        ...
        async executeTargetState(targetState) {
          // 显示格挡
          if (targetState.block && this.$fightMap.isPlayAnimation) {// await this.showString("格挡")
...
//# sourceMappingURL=3c9b5c39780f2108a7ae4374a08c5e816c931a99.js.map