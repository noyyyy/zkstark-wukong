System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, __checkObsolete__, __checkObsoleteInNamespace__, BasicState, CharacterEnum, EquipmentState, CharacterState, _crd;
    ...
    execute: function () {
      ...
      _export("CharacterState", CharacterState = class CharacterState extends (_crd && BasicState === void 0 ? (_reportPossibleCrUseOfBasicState({
        ...
        constructor(create, component) {
          ...
          this.maxHp = meta.BasicHp + create.strength * 200; // create.lv * meta.HpGrowth * ((create.star - 1) * 0.15 + 1) * (create.lv / 80 + 0.8)

          this.attack = meta.BasicAttack + create.strength * 130; // create.lv * meta.AttackGrowth * ((create.star - 1) * 0.15 + 1) * (create.lv / 80 + 0.8)

          this.defence = 0; // create.lv * meta.DefenceGrowth * ((create.star - 1) * 0.15 + 1) * (create.lv / 80 + 0.8)

          this.speed = meta.BasicSpeed + create.agility * 5; // create.lv * meta.SpeedGrowth * ((create.star - 1) * 0.15 + 1) * (create.lv / 80 + 0.8)

          this.pierce = 0; // create.lv * meta.PierceGrowth * ((create.star - 1) * 0.15 + 1) * (create.lv / 80 + 0.8)

          this.critical = 0; // meta.Critical
        ...
        addEquipment(equipment) {
          const equipmentState = new (_crd && EquipmentState === void 0 ? (_reportPossibleCrUseOfEquipmentState({
            error: Error()
...
//# sourceMappingURL=4e3eec7f715d9799452357a7e60d1a724b8511d5.js.map