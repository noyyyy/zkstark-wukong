    ...
    execute: function () {
      ...
      _export("FightUi", FightUi = (_dec = ccclass('FightUi'), _dec2 = property(Node), _dec(_class = (_class2 = class FightUi extends Component {
        ...
        setTimeScale(e) {
          ...
          for (const node of this.FightMapNode.children) node.getComponent(_crd && HolCharacter === void 0 ? (_reportPossibleCrUseOfHolCharacter({
            error: Error()
        ...
        async skipFight() {
          ...
          if (result) {
            this.FightMapNode.getComponent(_crd && FightMap === void 0 ? (_reportPossibleCrUseOfFightMap({
              error: Error()
...
//# sourceMappingURL=fb687be362cfa5786a6d12cb598a8705bf37aa36.js.map