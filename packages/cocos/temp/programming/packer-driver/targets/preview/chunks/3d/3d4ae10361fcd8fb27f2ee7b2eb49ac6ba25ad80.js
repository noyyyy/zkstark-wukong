System.register(["__unresolved_0"], function (_export, _context) {
  ...
  var _reporterNs, Resource, VolumeDetail, UserData, Config, _crd, globalId, config;
  ...
  function getConfig() {
    ...
    var configJSON = localStorage.getItem("UserConfigData");
    ...
    execute: function () {
      ...
      UserData = class UserData extends Resource {
        constructor(or) {
          ...
          ;
          or.characterQueue.forEach((cq, i) => cq.forEach((c, j) => this.characterQueue[i][j] = _extends({}, c, {
            uuid: ++globalId
          })));
        } // 添加新装备
        ...
        addNewCharacter(character) {
          var equipment = [];
          (character.equipment || []).forEach(e => equipment.push(_extends({}, e, {
            uuid: ++globalId
          })));
          this.characters.push(_extends({}, character, {
...
//# sourceMappingURL=3d4ae10361fcd8fb27f2ee7b2eb49ac6ba25ad80.js.map