        ...
        GetOnAttack() {
          return /*#__PURE__*/_asyncToGenerator(function* (self, actionState, fightMap) {
            ...
            if (self.star >= 4 && Math.random() < 0.2) {
              if (fightMap.isPlayAnimation) yield self.component.showString("再次出手");
              yield self.component.action();
            }
...
//# sourceMappingURL=0b7878798caf0b79b8422fe31f1fe950c43e56cc.js.map