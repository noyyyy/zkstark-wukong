    ...
    execute: function () {
      ...
      _export("HolCharacter", HolCharacter = (_dec = ccclass('HolCharacter'), _dec(_class = class HolCharacter extends Component {
        ...
        action() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (actionState.actionMethod === "attack" && actionState.canAction) {
              ...
              yield _this3.state.OnAttack(_this3.state, actionState, _this3.$fightMap); // 攻击回蓝

              _this3.state.energy += 20 + 3 * _this3.state.intelligence1;
        ...
        executeTargetState(targetState) {
          ...
          return _asyncToGenerator(function* () {
            // 显示格挡
            if (targetState.block && _this10.$fightMap.isPlayAnimation) {// await this.showString("格挡")
...
//# sourceMappingURL=b345ff3fa1cf0aea761f7cd78e7155b6cf4bcb01.js.map