      ...
      _export("HolCharacterAvatar", HolCharacterAvatar = (_dec = ccclass('HolCharacterAvatar'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class HolCharacterAvatar extends Component {
        ...
        setCharacter(create) {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.AvatarNode.getComponent(Sprite).spriteFrame = yield (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
              error: Error()
            }), util) : util).bundle.load(meta.AvatarPath, SpriteFrame);
            if (meta.CharacterQuality < 5) _this.LegendBorderNode.active = false;
            _this.BorderNode.getComponent(Sprite).spriteFrame = yield (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
              error: Error()
            }), util) : util).bundle.load("image/quality_border/" + meta.CharacterQuality + "/spriteFrame", SpriteFrame);
            _this.CampNode.getComponent(Sprite).spriteFrame = yield (_crd && util === void 0 ? (_reportPossibleCrUseOfutil({
              error: Error()
            }), util) : util).bundle.load("image/camp_icon/" + meta.CharacterCamp + "/spriteFrame", SpriteFrame);
            _this.LvNode.getComponent(Label).string = 'Lv: ' + create.lv;
          })();
        }
...
//# sourceMappingURL=507305b435d9d3a9dc702ff0907ebf4a2879667f.js.map